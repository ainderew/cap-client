...
const ProductPreview: React.FC = () => {
  return (
    <div className='h-screen w-full items-center justify-center md:flex'>
      <div className='m-auto h-[80%] relative w-full md:w-[70%] rounded-xl bg-[rgba(255,255,255,0.3)] p-4 backdrop-blur-2xl'>
